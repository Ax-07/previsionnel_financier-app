...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        // Base — layout, focus, commun à toutes les variantes
        ...
        // Variante default — sur fond clair (bg-muted) : texte foncé
        ...
        // Variante line — sur fond coloré (bg-primary) : toujours blanc
        "group-data-[variant=line]/tabs-list:bg-transparent",
        "group-data-[variant=line]/tabs-list:text-primary-foreground",
        "group-data-[variant=line]/tabs-list:hover:text-primary-foreground/60",
        "group-data-[variant=line]/tabs-list:data-[state=active]:bg-transparent",
        "group-data-[variant=line]/tabs-list:data-[state=active]:shadow-none",
        "group-data-[variant=line]/tabs-list:data-[state=active]:text-primary-foreground",
        "group-data-[variant=line]/tabs-list:data-[state=active]:font-semibold",

        // Indicateur (ligne active) — blanc sur line, foreground sur default
        "after:absolute after:opacity-0 after:transition-opacity",
        "group-data-[orientation=horizontal]/tabs:after:inset-x-0 group-data-[orientation=horizontal]/tabs:after:-bottom-1.25 group-data-[orientation=horizontal]/tabs:after:h-1",
        "group-data-[orientation=vertical]/tabs:after:inset-y-0 group-data-[orientation=vertical]/tabs:after:-right-1 group-data-[orientation=vertical]/tabs:after:w-0.5",
        "group-data-[variant=line]/tabs-list:after:bg-primary-foreground",
        "group-data-[variant=default]/tabs-list:after:bg-foreground",
